        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.m0607_b002:
                    intent.putExtra("aa", getString(R.string.m0000_b0501));
                    intent.setClass(M0607.this, M0501.class);
                    break;
                case R.id.m0607_b003:
                    intent.putExtra("bb", getString(R.string.m0000_b0502));
                    intent.setClass(M0607.this, M0502.class);
                    break;
                case R.id.m0607_b004:
                    intent.putExtra("cc", getString(R.string.m0000_b0503));
                    intent.setClass(M0607.this, M0503.class);
                    break;
                case R.id.m0607_b005:
                    intent.putExtra("dd", getString(R.string.m0000_b0504));
                    intent.setClass(M0607.this, M0505.class);
                    break;
                case R.id.m0607_b006:
                    intent.putExtra("ee", getString(R.string.m0000_b0601));
                    intent.setClass(M0607.this, M0601.class);
                    break;
                case R.id.m0607_b007:
                    intent.putExtra("ff", getString(R.string.m0000_b0606));
