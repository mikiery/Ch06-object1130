...
public class M0606 extends AppCompatActivity {
    ...
    private void setupViewComponent() {
        ...
        Scissors = (ImageButton) findViewById(R.id.m0606_b001);
        Stone = (ImageButton) findViewById(R.id.m0606_b002);
        Net = (ImageButton) findViewById(R.id.m0606_b003);
    ...
    private View.OnClickListener buttonOn = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.m0606_b001:   //選擇剪刀  scissors
                    u_setalpha();//歸0一定要放上面
                    user_select = getString(R.string.m0606_s001) + " " + getString(R.string.m0606_b001);
                    Scissors.getBackground().setAlpha(150); //0-255
                    switch (iComPlay) {
                        case 1:
                ...
                case R.id.m0606_b002:   //我選擇石頭  stone
                    u_setalpha();
                    Stone.getBackground().setAlpha(150);
                ...
                case R.id.m0606_b003:   //我選擇布  net
                    u_setalpha();
                    Net.getBackground().setAlpha(150);
        ...
        private void u_setalpha() {
            ...
            Scissors.setBackgroundColor(Color.GRAY);
            Scissors.getBackground().setAlpha(0); //0-255
            Stone.setBackgroundColor(Color.GRAY);
            Stone.getBackground().setAlpha(0);
            Net.setBackgroundColor(Color.GRAY);
            Net.getBackground().setAlpha(0);
    ...
    private void music(int i) {
        ...
        switch (i) {
            case 1:
                ...
                musichaha.start();
                Toast.makeText(getApplicationContext(), R.string.m0606_f003, Toast.LENGTH_SHORT).show();
                break;
            case 2:

                musiclose.start();
                Toast.makeText(getApplicationContext(), R.string.m0606_f002, Toast.LENGTH_SHORT).show();
                break;
            case 3:
